...
describe Puppet::Type.type(:netapp_nfs_export) do
  ...
  before do 
    ...
    described_class.provider(:sevenmode).new(@export_example)
  end
  ...
  describe "when validating values" do
    ...
    describe "for anon" do
      ...
      it "insync? should return false if is and should values dont match" do
        ...
        is_anon = '1'
        export[:anon] = '0'
        described_class.new(export).property(:anon).insync?(is_anon).should be_falsey
      end
      ...
      it "insync? should return true if is and should values match" do
        ...
        is_anon = '0'
        export[:anon] = '0'
        described_class.new(export).property(:anon).insync?(is_anon).should be_truthy
      end
    end
    ...
    describe "for readonly" do
      ...
      it "insync? should return false if 'is' is not an array" do
        ...
        described_class.new(export).property(:readonly).insync?(is_readonly).should be_falsey
      end
      ...
      it "insync? should return true if 'is' and 'should' = 'all_hosts'" do
        ...
        described_class.new(export).property(:readonly).insync?(is_readonly).should be_truthy
      end
    ...
    describe "for readwrite" do
      ...
      it "insync? should return false if 'is' is not an array" do
        ...
        described_class.new(export).property(:readwrite).insync?(is_readwrite).should be_falsey
      end
      ...
      it "insync? should return true if 'is' and 'should' = 'all_hosts'" do
        ...
        described_class.new(export).property(:readwrite).insync?(is_readwrite).should be_truthy
      end
